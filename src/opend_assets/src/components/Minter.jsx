...
function Minter() {
  ...
  console.log("nftPrincipal", nftPrincipal);
  ...
  async function onSubmit(data) {
    ...
    const newNFTPrincipal = await opend.mint(imgByteData, name);
    const newNFTPrincipalId = newNFTPrincipal.toText();
    setNftPrincipal(newNFTPrincipalId);
